...
title = "Projects"
date = "2026-09-13"
sourceURL = "http://pjordanolab.ebd.csic.es/projects/"
weight = 40
layout = "twocolumn"
[menu.main]
  name = "Projects"
...
Our previous work on this topic has concentrated on analyses for the whole Angiosperm clade. Recently we are collaborating with Mauro Galetti and Marco Pizo, involving comparative analyses restricted to the tropical families Palmae and Myrtaceae. Together with Paulo R. Guimarães Jr., Mauro and Mathias Pires we are also analyzing the comparative ecology of the so-called [anachronic seed dispersal systems](http://pjordanolab.ebd.csic.es/gallery/page10/ "Megafauna fruits"), i.e., plant species with extremely large fruits supposedly dispersed by an extinct megafauna and having present-day interactions with surrogate frugivorous animals. The dataset, and additional information, for this study is available [here](http://pjordanolab.ebd.csic.es/datasets/ "Datasets").
